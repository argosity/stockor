(function (root, callback) {
  ...
  // Globals
    ...
    var previousSupermodel = root.Supermodel;

    callback(root.Supermodel = {}, root.Backbone, root._);
    // `noConflict` support.  Retain a reference to
    // the previous definition of Supermodel, and restore
    // it when noConflict is called
    root.Supermodel.noConflict = function(){
        root.Supermodel = previousSupermodel;
        return this;
    };
